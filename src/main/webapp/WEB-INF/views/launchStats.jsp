...
<script type="text/javascript" src="resources/js/stats/launchStats.js"></script>
						...
						'http://localhost:8080/statistics/service/statistics/commons/app/',
						{
							...
							jq.each(responseData, function(index, item) {
								if (index == 0) {
									...
									updateLaunchData(appId,window.allChart);
								}
...
<script>
	jq("#application").change(function() {
		updateLaunchData(jq("#application").val(), window.allChart);
