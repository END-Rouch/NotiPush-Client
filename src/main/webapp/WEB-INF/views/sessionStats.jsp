...
<script type="text/javascript" src="resources/js/stats/sessionStats.js"></script>
						...
						'http://localhost:8080/statistics/service/statistics/commons/app/',
						{
							...
							jq.each(responseData, function(index, item) {
								if (index == 0) {
									...
									updateSessionData(appId,window.iOSChart);
...
<script>
	jq("#application").change(function() {
		updateSessionData(jq("#application").val(), window.iOSChart);
